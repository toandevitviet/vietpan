    ...
    protected function getListQuery() {
        ...
        if (!empty($search)) {
            if (stripos($search, 'id:') === 0) {
                ...
                $query->where('( a.name LIKE '.$search.'  OR  a.image LIKE '.$search.'  OR  a.price LIKE '.$search.'  OR  a.short_description LIKE '.$search.'  OR  a.description LIKE '.$search.'  OR  a.category_id LIKE '.$search.' )');
            }
        }
