...
class ProductViewProducts extends JViewLegacy {
	...
	protected function getSortFields()
	{
		...
		'a.price' => JText::_('COM_PRODUCT_PRODUCTS_PRICE'),
		'a.short_description' => JText::_('COM_PRODUCT_PRODUCTS_SHORT_DESCRIPTION'),
		'a.description' => JText::_('COM_PRODUCT_PRODUCTS_DESCRIPTION'),
